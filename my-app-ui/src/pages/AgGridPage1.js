...
function AgGridPage1() {
  ...
  const getData = () => {
    return [
      ...
      {
        productName: "External GPU",
        salesRevenue: 45000,
        profitMargin: 0.14,
        status: "Delivered",
      },
      {
        productName: "RAM Module",
        salesRevenue: 8600,
        profitMargin: 0.21,
        status: "Pending",
      },
      ...
      {
        productName: "Desk Bike",
        salesRevenue: 27500,
        profitMargin: 0.16,
        status: "Delivered",
      },
      {
        productName: "Standing Mat",
        salesRevenue: 1950,
        profitMargin: 0.38,
        status: "Delivered",
      },
