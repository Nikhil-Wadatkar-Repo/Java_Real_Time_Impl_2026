...
public class EmployeeService {
    ...
    private static final List<String> FIRST_NAMES = Arrays.asList(
            "Aarav", "Vivaan", "Aditya", "Arjun", "Ishaan", "Vihaan", "Kabir", "Rohan",
            "Rahul", "Neha", "Priya", "Ananya", "Kavya", "Sneha", "Pooja", "Meera");

    private static final List<String> LAST_NAMES = Arrays.asList(
            "Sharma", "Verma", "Gupta", "Mehta", "Patel", "Singh", "Iyer", "Nair",
            "Kapoor", "Joshi", "Reddy", "Chopra", "Mishra", "Malhotra", "Bansal", "Bhat");

    private static final List<String> CITIES = Arrays.asList(
            "Bengaluru", "Hyderabad", "Pune", "Chennai", "Mumbai", "Delhi", "Ahmedabad", "Kolkata");

    private static final List<String> STATES = Arrays.asList(
            "Karnataka", "Telangana", "Maharashtra", "Tamil Nadu", "Delhi", "Gujarat", "West Bengal", "Rajasthan");

    private static final List<String> COUNTRIES = Arrays.asList(
            "India", "India", "India", "India");

    private static final List<String> DESIGNATIONS = Arrays.asList(
            "Software Engineer", "Senior Software Engineer", "QA Engineer", "Business Analyst",
            "DevOps Engineer", "Data Analyst", "Product Analyst", "Support Engineer");

    private static final List<String> EMPLOYMENT_TYPES = Arrays.asList(
    ...
    public List<EmployeeDepartmentView> findAllWithDepartmentNameNPlusOneDemo() {
        ...
        log.info("Loaded {} employees. Accessing lazy department relation inside the loop to demonstrate N+1.",
                employees.size());
        ...
        for (Employee employee : employees) {
            ...
            // problem.
            String departmentName = employee.getDepartment() == null ? null
    ...
    public List<EmployeeDepartmentView> findAllWithDepartmentNameJoinFetch() {
        ...
        log.info("Loaded {} employees using JOIN FETCH. Department relation is initialized in one query.",
                employees.size());
    ...
    public BulkSeedResponse seedRealTimeEmployees(int count) {
        ...
        return BulkSeedResponse.builder()
                ...
                .insertedCount(count)
                .durationMs(duration)
                .message("Inserted " + count + " employee records with realistic generated data")
                .build();
    }
    ...
    private Employee buildRealTimeEmployee(int index, String runToken) {
        ...
        return Employee.builder()
                ...
                .lastName(lastName)
                .email(email)
                .phoneNumber(9000000000L + random.nextLong(100000000L))
                .hireDate(LocalDate.now().minusDays(random.nextInt(30, 3650)))
                .jobId(100 + random.nextInt(900))
                .salary(BigDecimal.valueOf(random.nextDouble(30000.0, 250000.0)).setScale(2, RoundingMode.HALF_UP))
                .managerId(10 + random.nextInt(90))
                .departmentId(1 + random.nextInt(25))
                .address(random.nextInt(100, 9999) + " " + lastName + " Street")
                ...
                .designation(DESIGNATIONS.get(random.nextInt(DESIGNATIONS.size())))
